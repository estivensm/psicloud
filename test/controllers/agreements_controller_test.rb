...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { admin_user: @agreement.admin_user, description: @agreement.description, name: @agreement.name, percent: @agreement.percent, user_id: @agreement.user_id } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { admin_user: @agreement.admin_user, description: @agreement.description, name: @agreement.name, percent: @agreement.percent, user_id: @agreement.user_id } }
