...
class AccountTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_type" do
    assert_difference('AccountType.count') do
      post account_types_url, params: { account_type: { file_size: @account_type.file_size, name: @account_type.name, users: @account_type.users } }
    end
  ...
  test "should update account_type" do
    patch account_type_url(@account_type), params: { account_type: { file_size: @account_type.file_size, name: @account_type.name, users: @account_type.users } }
