...
protected
  ...
  def configure_permitted_parameters
    ...
    devise_parameter_sanitizer.permit(metodo, keys: [:email,:company,:names,:last_names,:admin_user,:rol_id,:avatar, :birth_date,:document,:document_type, :medical_record,:state,:account,:count,:legal,:ip_address,:device,:phone, :firma_adjunta, :tipo_firma, :professional_card, :signature_format ])
    end
  end
